...
``````{r, echo = FALSE, warning = FALSE, message = FALSE}
knitr::kable(aggregate_table, col.names = c("Industry", "Average Net Worth", "Average Age", "Proportion of Women", "Proportion of Men"), caption = "Billionaire Data by Industry")
```
