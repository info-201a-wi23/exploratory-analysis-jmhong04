...
The Forbes Top World Billionaires List of 2022 includes 2668 billionaires from around the world. When calculating the average age among the billionaires, it was `r average_age`. From this data, we are also able to calculate the breakdown of gender, privilege, location, and philanthropy scores to see who is in the majority. After calculating the gender make-up of the 2022 billionaire list, the proportion of men is greater than the proportion of women. The proportion of women was `r perc_of_women` while the proportion of men was `r perc_of_men`, nearly eight times higher than the proportion of women. Interestingly, when calculating the proportions of privilege, the proportion of billionaires with inherited wealth, `r proportion_inherited`, is significantly lower than the proportion of self-made billionaires, `r proportion_selfMade`. The country with the highest number of billionaires was `r highest_num_country`. And, the state within the U.S with the highest number of billionaires was `r highest_num_state`. The average philanthropy score among billionaires in the United States was `r avg_philantrophy` out of 5.


### Table

```{r, echo = FALSE, warning = FALSE, message = FALSE}
knitr::kable(aggregate_table, col.names = c("Industry", "Average Net Worth (in Billions)", "Average Age", "Proportion of Women", "Proportion of Men"), caption = "Billionaire Data by Industry")
```
...
This stacked histogram aims to demonstrate the correlation between billionaires’ source of wealth and privilege, specifically whether or not they are self-made, and their philanthropy score. The philanthropy scores were determined by the value of a billionaire’s donations throughout their life in ratio to the sum of their total donations and net worth. From a scale of 1 to 5, 1 is the least charitable while 5 is the most charitable. 
